...
![](Tuition-Variation-Research_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->

``` r
hist(Public_60$Rank, xlab= "School Rank", main= "Histogram of Public School Ranks" , col= viridis(7) )
```

![](Tuition-Variation-Research_files/figure-gfm/unnamed-chunk-13-2.png)<!-- -->
...
![](Tuition-Variation-Research_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](Tuition-Variation-Research_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](Tuition-Variation-Research_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
![](Tuition-Variation-Research_files/figure-gfm/unnamed-chunk-21-1.png)<!-- -->
